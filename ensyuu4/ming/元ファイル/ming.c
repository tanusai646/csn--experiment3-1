...
*/
int
improve(double *xp, double *yp, int maxi, struct xy *data, size_t sz)
{
  // 候補位置
  double x0 = *xp, y0 = *yp;
  // 加速度ベクトル
...
static int
get_vals(double *val1, double *val2, 
	 double x0, double y0, struct xy *data, size_t sz)
{
  double poten = 0.0;
  double accelx = 0.0, accely = 0.0;
  size_t i;
...
int
scanarea(int s, double key1, double key2, struct xy *data, size_t sz)
{
